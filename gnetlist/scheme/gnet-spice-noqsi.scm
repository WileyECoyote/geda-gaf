...
;;; Copyright (C) 2012-2015 John P. Doty
;
...
(define spice-noqsi-version "2015.08.08")
...
(define (spice-noqsi output-filename)
    (if help-flag?
        (spice-noqsi-help)
        (if version-flag?
            (spice-noqsi-show-version)
            (if have-input-file?
               (spice-noqsi-main output-filename)
               (error-no-input-file)
            )
        )
    )
...
(define (spice-noqsi-help)
  (newline)
  (display "Nosqi Spice backend -- Options:")
  (newline)
  (display "  -V, --version \tPrint version information.\n")
  (newline)
)

(define (spice-noqsi-show-version)
  (display spice-noqsi-version)
  (newline)
)
...
(define (write-header)
    ...
    (format #t "* SPICE file generated by spice-noqsi version ~a
