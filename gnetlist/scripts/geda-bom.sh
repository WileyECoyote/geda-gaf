...
#
#+ Authur of embedded Command Utility: Wiley Edward Hill
...
VER=1.1
TITLE="A script to generate a bom from a gEDA schematics"
...
if [ -z "${AwkProgram}" ] ; then
  echo "This command requires the awk command. Can not continue."
  exit 0;
fi
