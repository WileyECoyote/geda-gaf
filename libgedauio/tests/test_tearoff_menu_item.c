...
#define MUT "src/widgets/geda_tearoff_menu_item.c"

#define TWIDGET "GedaRadioMenuItem"

/*! \file test_tearoff_menu_item.c
 *  \brief Tests for geda_tearoff_menu_item.c module
 */
...
int check_construction (void)
{
  ...
  GtkWidget *widget = geda_tearoff_menu_item_new();

  if (!GEDA_IS_TEAROFF_MENU_ITEM(widget)) {
