...
/* STRING:STRING (./gtkmarshalers.list:12) */
...
/* VOID:BOXED (geda-marshal.list:14) */
...
/* VOID:BOXED,POINTER (geda-marshal.list:22) */
...
/* VOID:OBJECT,OBJECT (geda-marshal.list:24) */
...
/* VOID:DOUBLE,DOUBLE,DOUBLE,DOUBLE (geda-marshal.list:25) */
