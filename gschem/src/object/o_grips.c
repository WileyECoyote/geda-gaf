                                  ...
                                  int x, int y, int whichone)
{
  ...
  w_current->pixbuf_filename = geda_strdup (o_picture_get_filename (o_current));
                            ...
                            int whichone)
{
  ...
  o_net_modify (o_current, w_current->second_wx, w_current->second_wy, w_current->which_grip);
                            ...
                            int whichone)
{
  ...
  s_conn_remove_object (o_current);
  o_pin_modify (o_current, w_current->second_wx,
