                                                   ...
                                                   OBJECT *object)
{
  ...
  if (object != NULL && object->type == OBJ_TEXT) {
    ...
    widget = gtk_object_get_data(GTK_OBJECT(ThisDialog), "visbutton");
    ...
    /* Update Show Options */
    widget = gtk_object_get_data(GTK_OBJECT(ThisDialog), "show_options");
    ...
    widget = gtk_object_get_data(GTK_OBJECT(ThisDialog), "value_entry");
    if (val) {
    ...
    widget = gtk_object_get_data(GTK_OBJECT(ThisDialog), "attrib_combo_entry");
  ...
  gtk_object_set_data(GTK_OBJECT(ThisDialog), "attrib", object);
...
attrib_edit_dialog_ok(AttributeEditMode mode, GSCHEM_TOPLEVEL *w_current)
{
  ...
  value_entry  = gtk_object_get_data(GTK_OBJECT(ThisDialog), "value_entry");
  name_entry   = gtk_object_get_data(GTK_OBJECT(ThisDialog), "attrib_combo_entry");
  visbutton    = gtk_object_get_data(GTK_OBJECT(ThisDialog), "visbutton");
  show_options = gtk_object_get_data(GTK_OBJECT(ThisDialog), "show_options");
  ...
  if (mode == SAE_CREATE_NEW) {
    ...
    invocation_flag =
    GPOINTER_TO_INT( gtk_object_get_data(GTK_OBJECT(ThisDialog),
                                         "invocation_flag") );
    wx = GPOINTER_TO_INT( gtk_object_get_data(GTK_OBJECT(ThisDialog),
                                              "position_wx"));
    wy = GPOINTER_TO_INT( gtk_object_get_data(GTK_OBJECT(ThisDialog),
                                              "position_wy"));
    ...
    object =  gtk_object_get_data(GTK_OBJECT(ThisDialog), "attrib");
    if (object != NULL && object->type == OBJ_TEXT) {
