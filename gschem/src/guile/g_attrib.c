...
/*!
 * \brief Create the (gschem core object) Scheme module.
 * \par Function Description
 * Defines procedures in the (gschem core object) module. The module can
 * be accessed using (use-modules (gschem core object)).
 */
static void
