 ...
 *    and the boundary of handlebox->bin_window at the start of
...
/**
 * geda_handle_box_get_shadow_type:
 * @handle_box: a #GedaHandleBox
 *
...
/**
 * geda_handle_box_get_handle_position:
 * @handle_box: a #GedaHandleBox
 *
...
/**
 * geda_handle_box_get_child_detached:
 * @handle_box: a #GedaHandleBox
 *
    ...
    gtk_paint_box (widget->style,
      ...
      switch (handle_position)
      {
        ...
        case GTK_POS_BOTTOM:
          ...
          break;
        default:
          fprintf (stderr, "Internal Error: <%s><geda_handle_box_paint>"
  ...
  if ((event->button == 1) &&
      ...
      if (in_handle)
	{
              ...
              else
		{
          ...
          else if (handlebox->child_detached) /* Double click */
            {
