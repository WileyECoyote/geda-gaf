...
/**
 * SECTION:gedacomboboxtext
 * @Short_description: A simple, text-only combo box
 * @Title: GedaComboBoxText
 ...
 *
 * <refsect2 id="GedaComboBoxText-BUILDER-UI">
 * <title>GedaComboBoxText as GtkBuildable</title>
 * <para>
 ...
 *
 * <example>
 * <title>A UI definition fragment specifying GedaComboBoxText items</title>
 * <programlisting><![CDATA[
 * <object class="GedaComboBoxText">
 *   <items>
...
/**
 * geda_combo_box_text_remove_all:
 * @combo_box: A #GedaComboBoxText
 *
...
/**
 * geda_combo_box_text_get_active_text:
 * @combo_box: A #GedaComboBoxText
 *
