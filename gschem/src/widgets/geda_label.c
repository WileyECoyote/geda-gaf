...
*/
   ...
   * for details of how #GedaLabel:width-chars and #GedaLabel:max-width-chars
...
/**
 * geda_label_get_mnemonic_widget:
 * @label: a #GedaLabel
 *
...
/**
 * geda_label_get_mnemonic_keyval:
 * @label: a #GedaLabel
 *
...
/**
 * geda_label_set_pattern:
 * @label: The #GedaLabel you want to set the pattern to.
...
/**
 * geda_label_get_max_width_chars:
 * @label: a #GedaLabel
 *
...
/**
 * geda_label_set_max_width_chars:
 * @label: a #GedaLabel
...
/**
 * geda_label_get_selection_bounds:
 * @label: a #GedaLabel
...
/**
 * geda_label_set_use_markup:
 * @label: a #GedaLabel
 * @setting: %TRUE if the label's text should be parsed for markup.
 *
 * Sets whether the text of the label contains markup in <link
 * linkend="PangoMarkupFormat">Pango's text markup
 * language</link>. See geda_label_set_markup().
 **/
 ...
 * language</link>. See geda_label_set_use_markup ().
 *
...
/**
 * geda_label_set_track_visited_links:
 * @label: a #GedaLabel
...
/**
 * geda_label_get_track_visited_links:
 * @label: a #GedaLabel
 *
