 ...
 * also used to select the stock item if geda_menu_button_set_use_stock()
 * is used.
 *
 ...
 *
 * @object:  a GedaMenuButton
 * @prop_id: The enumerated property ID
 * @value:   The value to set the property
 * @pspec:   The parameter specifications for the property
 */
static void
 ...
 * @object:       a GedaMenuButton
 * @prop_id:      The enumerated property ID
 * @value (out):  The variable that will be set to the property value
 * @pspec:        The parameter specifications for the property
 */
static void
...
/**
 * geda_menu_button_set_menu:
 * @button: a #GedaMenuButton
 * @menu: the #GtkMenu associated with #GedaMenuButton
 *
