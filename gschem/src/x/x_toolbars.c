...
static ToolbarStringData ToolbarStrings[] = {
   /* Standard Toolbar*/
  { ACTION(FILE_NEW),          N_("New"),       TBTS_FILE_NEW,            GSCHEM_MAP(NEW),           TB_ICON_BITMAP, NULL},
  { ACTION(FILE_OPEN),         N_("Open"),      TBTS_FILE_OPEN,           GSCHEM_MAP(OPEN),          TB_ICON_BITMAP, NULL},
  { ACTION(FILE_SAVE),         N_("Save"),      TBTS_FILE_SAVE,           GSCHEM_MAP(SAVE),          TB_ICON_BITMAP, NULL},
  { ACTION(FILE_SAVE_AS),      N_("Save As"),   TBTS_FILE_SAVE_AS,       "gschem-save-as",           TB_ICON_STOCK, NULL},
  { ACTION(FILE_CLOSE),        N_("Close"),     TBTS_FILE_CLOSE,          GSCHEM_MAP(PROJECT_CLOSE), TB_ICON_BITMAP, NULL},

  { ACTION(FILE_PRINT),        N_("Print"),     TBTS_FILE_PRINT,         "gschem-print-document",    TB_ICON_STOCK,  NULL},
  { ACTION(FILE_WRITE_PDF),    N_("PDF"),       TBTS_FILE_WRITE_PDF,      GAF_PDF_BITMAP,            TB_ICON_BITMAP, NULL},

  { ACTION(EDIT_CB_CUT),       N_("Cut"),       TBTS_EDIT_CB_CUT,        "gtk-cut",           TB_ICON_STOCK,  NULL},
  { ACTION(EDIT_CB_COPY),      N_("Copy"),      TBTS_EDIT_CB_COPY,       "gtk-copy",          TB_ICON_STOCK,  NULL},
  { ACTION(EDIT_CB_PASTE),     N_("Paste"),     TBTS_EDIT_CB_PASTE,      "gtk-paste",         TB_ICON_STOCK,  NULL},

  { ACTION(EDIT_UNDO),         N_("Undo"),      TBTS_EDIT_UNDO,           GSCHEM_MAP(UNDO),   TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_REDO),         N_("Redo"),      TBTS_EDIT_REDO,           GSCHEM_MAP(REDO),   TB_ICON_BITMAP, NULL},

  { ACTION(EDIT_SELECT),       N_("Select"),    TBTS_EDIT_SELECT,        "gschem-select",     TB_ICON_STOCK, NULL},
  { ACTION(EDIT_DESELECT),     N_("Deselect"),  TBTS_EDIT_DESELECT,      "gschem-unselect",   TB_ICON_STOCK, NULL},
  { ACTION(EDIT_DESELECT_ALL), N_("Unselect"),  TBTS_EDIT_DESELECT_ALL,  "unselect-all",      TB_ICON_STOCK, NULL},

  { "nil",                      "nil",        "nil",                  "gtk-no", 0, 0}, /* dummy corresponding to etb_none */

  { ACTION(EDIT_SELECT_ALL),   N_("All"),       TBTS_EDIT_SELECT_ALL,    "gschem-select-all", TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_INVERT),       N_("Invert"),    TBTS_EDIT_INVERT,        "gschem-invert",     TB_ICON_BITMAP, NULL},
  { ACTION(ADD_COMPONENT),     N_("Library"),   TBTS_ADD_COMPONENT,      "gschem-transistor", TB_ICON_BITMAP, NULL},
  { ACTION(ADD_NET),           N_("Nets"),      TBTS_ADD_NET,            "geda-net",          TB_ICON_STOCK, NULL},
  { ACTION(ADD_BUS),           N_("Bus"),       TBTS_ADD_BUS,            "geda-bus",          TB_ICON_STOCK, NULL},
  { ACTION(ADD_ATTRIB),        N_("Attrib"),    TBTS_ADD_ATTRIB,         "insert-attribute",  TB_ICON_STOCK, NULL},
  { ACTION(ADD_TEXT),          N_("Text"),      TBTS_ADD_TEXT,           "gtk-bold",          TB_ICON_STOCK, NULL},
  ...
  { ACTION(ADD_PICTURE),       N_("Image"),     TBTS_ADD_PICTURE,        "geda-film-roll", TB_ICON_STOCK, NULL},

  /* Page Toolbar */
  { ACTION(PAGE_FIRST),        N_("First"),     TBTS_PAGE_FIRST,         "gtk-goto-first",    TB_ICON_STOCK, NULL},
  { ACTION(PAGE_PREV),         N_("Prev"),      TBTS_PAGE_UP,            "gtk-go-back",       TB_ICON_STOCK, NULL},
  { ACTION(PAGE_NEXT),         N_("Next"),      TBTS_PAGE_DOWN,          "gtk-go-forward",    TB_ICON_STOCK, NULL},
  { ACTION(PAGE_UP),           N_("Up"),        TBTS_PAGE_UP,            "gtk-go-up",         TB_ICON_STOCK, NULL},
  { ACTION(PAGE_DOWN),         N_("Down"),      TBTS_PAGE_DOWN,          "gtk-go-down",       TB_ICON_STOCK, NULL},
  { ACTION(PAGE_LAST),         N_("Last"),      TBTS_PAGE_LAST,          "gtk-goto-last",     TB_ICON_STOCK, NULL},
  { ACTION(PAGE_NEW),          N_("New"),       TBTS_PAGE_NEW,           "gtk-new",           TB_ICON_STOCK, NULL},
  { ACTION(PAGE_MANAGER),      N_("Manage"),    TBTS_PAGE_MANAGER,       GEDA_SHEETS_BITMAP,  TB_ICON_BITMAP, NULL},

  { ACTION(DOWN_SCHEMATIC),    N_("Down"),      TBTS_DOWN_SCHEMATIC,     GEDA_DEMOTE_SCH_BITMAP, TB_ICON_BITMAP, NULL},
  { ACTION(DOWN_SYMBOL),       N_("Down"),      TBTS_DOWN_SYMBOL,        GEDA_DEMOTE_SYM_BITMAP, TB_ICON_BITMAP, NULL},
  { ACTION(HIERARCHY_UP),      N_("Up"),        TBTS_HIERARCHY_UP,       GEDA_PROMOTE_BITMAP,    TB_ICON_BITMAP, NULL},

  { ACTION(VIEW_DOCUMENT),     N_("Spec"),      TBTS_VIEW_DOCUMENT,      "gaf-see-notes",        TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_NETS),         N_("Netnames"),  TBTS_VIEW_NETNAMES,      "geda-show-nets",       TB_ICON_STOCK,  NULL},

  /* Zoom Toolbar */
  { ACTION(VIEW_REDRAW),       N_("Redraw"),    TBTS_VIEW_REDRAW,        GEDA_MAP(VIEW_REDRAW),  TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_PAN),          N_("Pan"),       TBTS_VIEW_PAN,           GEDA_MAP(ZOOM_PAN),     TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_BOX),          N_("Window"),    TBTS_VIEW_BOX,           GEDA_MAP(ZOOM_BOX),     TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_SELECTED),     N_("Selected"),  TBTS_VIEW_SELECTED,      "zoom-selection",       TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_EXTENTS),      N_("Extents"),   TBTS_VIEW_EXTENTS,       GEDA_MAP(ZOOM_EXTENTS), TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_ZOOM_IN),      N_("In"),        TBTS_VIEW_ZOOM_IN,       GEDA_MAP(ZOOM_IN),      TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_ZOOM_OUT),     N_("Out"),       TBTS_VIEW_ZOOM_OUT,      "zoom-out",             TB_ICON_STOCK,  NULL},
  { ACTION(VIEW_ZOOM_ALL),     N_("All"),       TBTS_VIEW_ZOOM_ALL,      GEDA_MAP(ZOOM_LIMITS),  TB_ICON_BITMAP, NULL},

  /* Symbol Toolbar */
  { ACTION(EDIT_COMPONENT),    N_("Properties"),TBTS_EDIT_PROPERTIES,    "geda-properties",      TB_ICON_STOCK,  NULL},

  { ACTION(TOOLS_TRANSLATE),   N_("Translate"), TBTS_TOOLS_TRANSLATE,    GEDA_MAP(TRANSLATE),    TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_LOCK),         N_("Lock"),      TBTS_SELECT_LOCK,        "Private",              TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_UNLOCK),       N_("Unlock"),    TBTS_SELECT_UNLOCK,      "Private",              TB_ICON_BITMAP, NULL},
  { ACTION(TOOLS_UPDATE),      N_("Update"),    TBTS_TOOLS_UPDATE,       "Private",              TB_ICON_BITMAP, NULL},

  /* Edit Toolbar */
  { ACTION(EDIT_COPY),         N_("Copy"),      TBTS_EDIT_COPY,          "Private",        TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_MCOPY),        N_("Multi"),     TBTS_EDIT_MCOPY,         "Private",        TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_MOVE),         N_("Move"),      TBTS_EDIT_MOVE,          "geda-move",      TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_MIRROR),       N_("Mirror"),    TBTS_EDIT_MIRROR,        "Private",        TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_OFFSET),       N_("Offset"),    TBTS_EDIT_OFFSET,        "geda-offset",    TB_ICON_BITMAP, NULL},
  ...
  { ACTION(EDIT_COLOR),        N_("Color"),     TBTS_EDIT_COLOR,         "Private",        TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_TEXT),         N_("Text"),      TBTS_EDIT_TEXT,          "Private",        TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_SLOT),         N_("Slots"),     TBTS_EDIT_SLOT,          "geda-slot",      TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_PIN),          N_("Pins"),      TBTS_EDIT_PIN,           "geda-pin-type",  TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_LINE),         N_("Line"),      TBTS_EDIT_LINE,          "Private",        TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_FILL),         N_("Fill"),      TBTS_EDIT_FILL,           GEDA_MAP(MESH),  TB_ICON_BITMAP, NULL},
  { ACTION(EDIT_ARC),          N_("Arcs"),      TBTS_EDIT_ARC,           "geda-arc-edit",  TB_ICON_BITMAP, NULL},

  /* Attribute Toolbar */
  { ACTION(ATTRIB_ATTACH),     N_("Promote"),   TBTS_ATTRIB_ATTACH,      "Private",                   TB_ICON_BITMAP, NULL},
  { ACTION(ATTRIB_DETACH),     N_("Demote"),    TBTS_ATTRIB_DETACH,      "Private",                   TB_ICON_BITMAP, NULL},
  { ACTION(ATTRIB_VALUE),      N_("Value"),     TBTS_ATTRIB_VALUE,        GEDA_MAP(VALUE),            TB_ICON_BITMAP, NULL},
  { ACTION(ATTRIB_NAME),       N_("Name"),      TBTS_ATTRIB_NAME,        "show-name",                 TB_ICON_BITMAP, NULL},
  { ACTION(ATTRIB_BOTH),       N_("Both"),      TBTS_ATTRIB_BOTH,         GEDA_MAP(NAME_VALUE),       TB_ICON_BITMAP, NULL},
  { ACTION(ATTRIB_VISIBILITY), N_("Visible"),   TBTS_ATTRIB_VISIBILITY,   GEDA_MAP(EYE_GLASSES),      TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_HIDDEN),       N_("Hidden"),    TBTS_VIEW_HIDDEN,        "show-hidden",               TB_ICON_BITMAP, NULL},
  { ACTION(VIEW_INHERITED),    N_("Inherited"), TBTS_VIEW_INHERITED,     "show-inherited",            TB_ICON_BITMAP, NULL},
  { ACTION(ATTRIB_FIND),       N_("Find"),      TBTS_ATTRIB_FIND,         GEDA_MAP(FIND_ATTRIBUTE),   TB_ICON_BITMAP, NULL},
  { ACTION(ATTRIB_HIDE),       N_("Hide"),      TBTS_ATTRIB_HIDE,        "geda-invisible",            TB_ICON_BITMAP, NULL},
  { ACTION(ATTRIB_SHOW),       N_("Show"),      TBTS_ATTRIB_SHOW,         GEDA_MAP(LOCATE_REFERENCE), TB_ICON_BITMAP, NULL},

  { ACTION(TOOLS_AUTONUM),     N_("Auto #"),    TBTS_TOOLS_AUTONUM,      "geda-autonum-blue.png",   TB_ICON_BITMAP, NULL},

  { ACTION(OPT_GRID_DOT),      N_("Dots"),      TBTS_OPT_GRID_DOT,       "geda-grid-dot",     TB_ICON_BITMAP, NULL},
  { ACTION(OPT_GRID_MESH),     N_("Mesh"),      TBTS_OPT_GRID_MESH,      "geda-grid-mesh",    TB_ICON_BITMAP, NULL},
  { ACTION(OPT_GRID_OFF),      N_("Off"),       TBTS_OPT_GRID_OFF,       "geda-display",      TB_ICON_BITMAP, NULL},

  { ACTION(OPT_SNAP_UP),       N_("UP"),        TBTS_OPT_SNAP_UP,        "geda-snap",         TB_ICON_BITMAP, NULL},
  { ACTION(OPT_SNAP_DOWN),     N_("Down"),      TBTS_OPT_SNAP_DOWN,      "geda-snap",         TB_ICON_BITMAP, NULL},
  { ACTION(OPT_SNAP_SIZE),     N_("Set"),       TBTS_OPT_SNAP_SIZE,      "geda-magnet",       TB_ICON_BITMAP, NULL},
  { ACTION(OPT_SNAP_OFF),      N_("Snap Off"),  TBTS_OPT_SNAP_OFF,       "geda-snap-off",     TB_ICON_BITMAP, NULL},
  { ACTION(OPT_SNAP_ON),       N_("Snap On"),   TBTS_OPT_SNAP_ON,        "geda-snap-on",      TB_ICON_BITMAP, NULL},

  { ACTION(OPT_SETTINGS),      N_("Config"),    TBTS_OPT_SETTINGS,        GEDA_MAP(TOOLS),    TB_ICON_BITMAP, NULL},
  { NULL, NULL, NULL},
};
...
static int popup_activated(GtkWidget *widget, IDS_HB_Popup_items* selection)
{
    ...
    switch ( WhichItem ) {
      ...
      case ShowText:
        geda_toolbar_set_style (ActiveToolBar.toolbar, TOOLBAR_SHOW_TEXT);
        break;
...
x_toolbars_init_left(GschemToplevel *w_current, GtkWidget *parent_container)
{
  ...
  geda_toolbar_append_space (GEDA_TOOLBAR(Edit_Toolbar));
