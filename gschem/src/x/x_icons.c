...
const char* IDS_GEDA_ICONS[] = {  /* Menu Icons Strings*/
  ...
  "geda-offset",        "geda-open-recent",   "geda-path",          "geda-pin",
  "geda-pin-type",      "geda-plot",          "geda-probe",         "geda-probe2",
  "geda-promote",       "geda-prompt",        "geda-save-image",    "geda-schem2",
  ...
  "geda-zoom-out",      "geda-zoom-pan",      "geda-zoom-selection","git-logo",
  "guile-logo",
  NULL
};
