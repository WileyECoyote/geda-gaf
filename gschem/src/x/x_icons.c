...
const char* IDS_GEDA_ICONS[] = {  /* Menu Icons Strings*/
  ...
  "geda-display",       "geda-display-color", "geda-draft",        "geda-film-roll",
  "geda-find",          "geda-grid-dot",      "geda-grid-mesh",
  "geda-icprint",       "geda-inbed",         "geda-inspect-grn",  "geda-invisible",
  "geda-lightning",     "geda-line",          "geda-line-type",    "geda-lock",
  "geda-net",           "geda-marker",        "geda-magnet",       "geda-mesh",
  "geda-mirror",        "geda-molecule",      "geda-move",         "geda-multi",
  "geda-name-tag",      "geda-name-value",    "geda-nand",         "geda-nand3",
  "geda-new",           "geda-node",          "geda-npn",          "geda-open-recent",
  "geda-path",          "geda-pin",           "geda-pin-type",     "geda-plot",
  "geda-probe",         "geda-probe2",        "geda-prompt",       "geda-save-image",
  ...
  "geda-wave",          "geda-waves",         "geda-redo",         "geda-rotate",
  "geda-snap-on",       "geda-spectrum",      "geda-text-editor",  "geda-tools",
  "geda-translate",     "geda-value",         "geda-undo",         "geda-unlock",
