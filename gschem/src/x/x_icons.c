...
const char* IDS_GEDA_ICONS[] = {  /* Menu Icons Strings*/
  "gaf-add-attribute",  "gaf-demote",         "gaf-hierarchy-sch",  "gaf-hierarchy-sym",
  "gaf-hierarchy-up",   "gaf-promote",        "gaf-see-notes",      "gaf-tools",
  ...
  "geda-calculate",     "geda-component",     "geda-copy",
