...
const char* IDS_GEDA_ICONS[] = {  /* Menu Icons Strings*/
  "gaf-add-attribute",  "gaf-demote",         "gaf-promote",        "gaf-see-notes",
  "gaf-tools",          "geda-arc",           "geda-arc-edit",      "geda-analysis",
  "geda-autonum-blue",  "geda-autonum-green", "geda-autonum-red",   "geda-bed",
  "geda-box",           "geda-bus",           "geda-check-grn",     "geda-check-org",
  "geda-check-red",     "geda-circle",        "geda-circles",       "geda-close",
  "geda-close-all",     "geda-calculate",     "geda-component",     "geda-copy",
  "geda-demote",        "geda-design",        "geda-design1",       "geda-design2",
  "geda-design3",       "geda-design4",       "geda-display",       "geda-display-color",
  "geda-draft",         "geda-film-roll",     "geda-find",          "geda-grid-dot",
  "geda-grid-mesh",     "geda-icprint",       "geda-inbed",         "geda-inspect-grn",
  "geda-invisible",     "geda-lightning",     "geda-line",          "geda-line-type",
  "geda-lock",          "geda-net",           "geda-marker",        "geda-magnet",
  "geda-mesh",          "geda-mirror",        "geda-molecule",      "geda-move",
  "geda-multi",         "geda-name-tag",      "geda-name-value",    "geda-nand",
  "geda-nand3",         "geda-new",           "geda-node",          "geda-npn",
  "geda-open-recent",   "geda-path",          "geda-pin",           "geda-pin-type",
  "geda-plot",          "geda-probe",         "geda-probe2",        "geda-promote",
  "geda-prompt",        "geda-save-image",    "geda-schem2",        "geda-schem",
  "geda-scope2",        "geda-scopehairs",    "geda-scope",         "geda-show-nets",
  "geda-simulate",      "geda-sinx",          "geda-slot",          "geda-snap-off",
  "geda-verilog-blue",  "geda-verilog-grn",   "geda-wave",          "geda-waves",
  "geda-redo",          "geda-rotate",        "geda-snap-on",       "geda-spectrum",
  "geda-text-editor",   "geda-tools",         "geda-translate",     "geda-value",
  "geda-undo",          "geda-unlock",        "geda-unselect-all",  "geda-zoom-box",
