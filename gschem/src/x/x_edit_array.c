 ...
 *  the pointer button to point to the array row and column offsets.
 *  This function fills in the offset distance in both the row and
 *  column entries when the dialog is redisplayed.
 */
