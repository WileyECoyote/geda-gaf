...
bool i_command_dispatch(gschem_task *task)
{
  scm_dynwind_begin (0);
...
/** @brief function i_cmd_do_repeat_last in i_command_Command_Handlers */
 ...
 *  @{
 */
/** @brief function i_cmd_do_file in i_command_Command_Handlers */
COMMAND (do_file)
{
...
/** @brief function i_cmd_do_new in i_command_Command_Functions */
COMMAND (do_file_new)
{
...
/** @brief function i_cmd_do_open in i_command_Command_Functions */
COMMAND ( do_open ) {
  BEGIN_COMMAND(do_open);
    x_fileselect_open (w_current);
  EXIT_COMMAND(do_open);
}
/** @brief function i_cmd_do_close in i_command_Command_Functions */
COMMAND ( do_close ) {
...
/** @brief function i_cmd_do_quit in i_command_Command_Functions */
COMMAND ( do_quit ) {
  BEGIN_NO_ARGUMENT(do_file_new_window);
...
/** @brief function i_cmd_do_save in i_command_Command_Functions */
 ...
 */
/** @brief function i_cmd_do_save_as in i_command_Command_Functions */
COMMAND ( do_save_as ) {
  NOT_NULL(w_current);
...
/** @brief function i_cmd_do_save_all in i_command_Command_Functions */
COMMAND ( do_save_all ) {
...
/** @brief function i_cmd_do_print in i_command_Command_Functions */
COMMAND ( do_print ) {
...
/** @brief function i_cmd_do_write_image in i_command_Command_Functions */
...
/** @brief function i_cmd_do_write_pdf in i_command_Command_Functions */
...
/** @brief function i_cmd_do_run_script in i_command_Command_Functions */
...
/** @brief function i_cmd_do_select_invert in i_command_Command_Functions
...
/** @brief function i_cmd_do_deselect in i_command_Command_Functions
...
/** @brief function i_cmd_do_copy in i_command_Command_Functions
...
/** @brief function i_cmd_do_mcopy in i_command_Command_Functions */
/*! \brief Make multi copies of selected objects on page.
 *  \par Function Description
 *   Initiate Multi-Copy mode for selected objects
 */
COMMAND ( do_mcopy )
{
...
/** @brief function i_cmd_do_move in i_command_Command_Functions */
...
/** @brief function i_cmd_unembed in i_command_Command_Functions */
COMMAND ( do_unembed )
{
...
/** @brief function i_cmd_update in i_command_Command_Functions */
COMMAND (do_update)
{
  NOT_NULL(w_current);
...
/** @brief function i_cmd_do_revert in i_command_Command_Functions */
 ...
 *
 */
/** @brief function i_cmd_do_add_line in i_command_Command_Functions */
COMMAND (do_add_line)
{
...
/** @brief function i_cmd_draw_grips in i_command_Variable_Handlers */
COMMAND (draw_grips) {
  SHOW_VARIABLE(draw_grips, R);
}

/** @brief function i_cmd_logging in i_command_Variable_Handlers */
COMMAND (logging) {
  SHOW_VARIABLE(logging, G);
}

/** @brief function i_cmd_grid_mode in i_command_Variable_Handlers */
COMMAND (grid_mode) {
  SHOW_VARIABLE(grid_mode, W);
}

/** @brief function i_cmd_dots_grid_dot_size in i_command_Variable_Handlers */
COMMAND (dots_grid_dot_size) {
  SHOW_VARIABLE(grid_mode, W);
}

/** @brief function i_cmd_dots_grid_fixed_threshold in i_command_Variable_Handlers */
COMMAND (dots_grid_fixed_threshold) {

  SHOW_VARIABLE(dots_grid_fixed_threshold, W);
}

/** @brief function i_cmd_dots_grid_mode in i_command_Variable_Handlers */
COMMAND (dots_grid_mode) {

  SHOW_VARIABLE(dots_grid_mode, W);
}

/** @brief function i_cmd_mesh_grid_threshold in i_command_Variable_Handlers */
COMMAND (mesh_grid_threshold) {

  SHOW_VARIABLE(mesh_grid_threshold, W);
}

/** @brief function i_cmd_object_clipping in i_command_Variable_Handlers */
COMMAND (object_clipping) {

  SHOW_VARIABLE(object_clipping, T);
}

/** @brief function i_cmd_scrollbars in i_command_Variable_Handlers */
COMMAND (scrollbars) {

  SHOW_VARIABLE(scrollbars, W);
}

/** @brief function i_cmd_scrollbar_update in i_command_Variable_Handlers */
COMMAND (scrollbar_update) {

  SHOW_VARIABLE(scrollbar_update, W);
}

/** @brief function i_cmd_scrollpan_steps in i_command_Variable_Handlers */
COMMAND (scrollpan_steps) {

  SHOW_VARIABLE(scrollpan_steps, W);
}

/** @brief function i_cmd_warp_cursor in i_command_Variable_Handlers */
COMMAND (warp_cursor) {

  SHOW_VARIABLE(warp_cursor, W);
}

/** @brief function i_cmd_world_size in i_command_Variable_Handlers */
COMMAND (world_size) {
...
/** @brief function i_cmd_zoom_gain in i_command_Variable_Handlers */
COMMAND (zoom_gain) {

  SHOW_VARIABLE(zoom_gain, W);
}

/** @brief function i_cmd_zoom_with_pan in i_command_Variable_Handlers */
COMMAND (zoom_with_pan) {

  SHOW_VARIABLE(zoom_gain, W);
}

/** @brief function i_cmd_log_destiny in i_command_Variable_Handlers */
COMMAND (log_destiny) {
  SHOW_VARIABLE(log_destiny, G);
}

/** @brief function i_cmd_console_window in i_command_Variable_Handlers */
COMMAND (console_window) {
  SHOW_VARIABLE(console_window, G);
}

/** @brief function i_cmd_console_window_type in i_command_Variable_Handlers */
COMMAND (console_window_type) {
  SHOW_VARIABLE(console_window_type, G);
}

/** @brief function i_cmd_action_feedback_mode in i_command_Variable_Handlers */
COMMAND (action_feedback_mode) {

  SHOW_VARIABLE(action_feedback_mode, W)
}

/** @brief function i_cmd_add_attribute_offset in i_command_Variable_Handlers */
COMMAND (add_attribute_offset) {

  SHOW_VARIABLE(add_attribute_offset, W);
}

/** @brief function i_cmd_auto_load_last in i_command_Variable_Handlers */
COMMAND (auto_load_last) {
  SHOW_VARIABLE(auto_load_last, G);
}

/** @brief function i_cmd_auto_save_interval in i_command_Variable_Handlers */
COMMAND (auto_save_interval) {

  SHOW_VARIABLE(auto_save_interval, T);
}

/** @brief function i_cmd_attribute_placement_grid in i_command_Variable_Handlers */
COMMAND (attribute_placement_grid) {

  SHOW_VARIABLE(attribute_placement_grid, W);
}

/** @brief function i_cmd_continue_component_place in i_command_Variable_Handlers */
COMMAND (continue_component_place) {

  SHOW_VARIABLE(continue_component_place, W);
}

/** @brief function i_cmd_embed_components in i_command_Variable_Handlers */
COMMAND (embed_components) {

  SHOW_VARIABLE(embed_components, W);
}

/** @brief function i_cmd_enforce_hierarchy in i_command_Variable_Handlers */
COMMAND (enforce_hierarchy) {

  SHOW_VARIABLE(enforce_hierarchy, W);
}

/** @brief function i_cmdfile_preview in i_command_Variable_Handlers */
COMMAND (file_preview) {

  SHOW_VARIABLE(file_preview, W);
}

/** @brief function i_cmd_force_boundingbox in i_command_Variable_Handlers */
COMMAND (force_boundingbox) {

  SHOW_VARIABLE(force_boundingbox, T);
}

/** @brief function i_cmd_keyboardpan_gain in i_command_Variable_Handlers */
COMMAND (keyboardpan_gain) {

  SHOW_VARIABLE(keyboardpan_gain, W);
}

/** @brief function i_cmd_magnetic_net_mode in i_command_Variable_Handlers */
COMMAND (magnetic_net_mode) {

  SHOW_VARIABLE(magnetic_net_mode, W);
}

/** @brief function i_cmd_netconn_rubberband in i_command_Variable_Handlers */
COMMAND (netconn_rubberband) {

  SHOW_VARIABLE(netconn_rubberband, W);
}

/** @brief function i_cmd_raise_dialog_boxes in i_command_Variable_Handlers */
COMMAND (raise_dialog_boxes) {

  SHOW_VARIABLE(raise_dialog_boxes, W);
}

/** @brief function i_cmd_select_slack_pixels in i_command_Variable_Handlers */
COMMAND (select_slack_pixels) {

  SHOW_VARIABLE(select_slack_pixels, W);
}

/** @brief function i_cmd_snap_size in i_command_Variable_Handlers */
COMMAND (snap_size) {

  SHOW_VARIABLE(snap_size, W);
}

/** @brief function i_cmd_sort_component_library in i_command_Variable_Handlers */
COMMAND (sort_component_library) {

  SHOW_VARIABLE(sort_component_library, W);
}

/** @brief function i_cmd_untitled_name in i_command_Variable_Handlers */
COMMAND(untitled_name) {

  s_log_message("<%s>", w_current->toplevel->untitled_name);
}

/** @brief function i_cmd_net_consolidate in i_command_Variable_Handlers */
COMMAND (net_consolidate) {

  SHOW_VARIABLE(net_consolidate, T);
}

/** @brief function i_cmd_net_endpoint_mode in i_command_Variable_Handlers */
COMMAND (net_endpoint_mode) {

  SHOW_VARIABLE(net_endpoint_mode, W);
}

/** @brief function i_cmd_net_midpoint_mode in i_command_Variable_Handlers */
COMMAND (net_midpoint_mode) {

  SHOW_VARIABLE(net_midpoint_mode, W);
}

/** @brief function i_cmd_net_direction_mode in i_command_Variable_Handlers */
COMMAND (net_direction_mode) {

  SHOW_VARIABLE(net_direction_mode,W);
}

/** @brief function i_cmd_net_selection_mode in i_command_Variable_Handlers */
COMMAND (net_selection_mode) {

  SHOW_VARIABLE(net_selection_mode, W)
}

/** @brief function i_cmd_bus_style in i_command_Variable_Handlers */
COMMAND ( bus_style ) {

  SHOW_VARIABLE(bus_style, T)
}
/** @brief function i_cmd_net_style in i_command_Variable_Handlers */
COMMAND ( net_style ) {

  SHOW_VARIABLE(net_style, T)
}
/** @brief function i_cmd_pin_style in i_command_Variable_Handlers */
COMMAND ( pin_style ) {

  SHOW_VARIABLE(pin_style, T)
}
/** @brief function i_cmd_line_style in i_command_Variable_Handlers */
COMMAND ( line_style ) {

  SHOW_VARIABLE(line_style, T)
}
/** @brief function i_cmd_thick_bus_width in i_command_Variable_Handlers */
COMMAND ( thick_bus_width ) {

  SHOW_VARIABLE(thick_bus_width, T)
}
/** @brief function i_cmd_thick_line_width in i_command_Variable_Handlers */
...
/** @brief function i_cmd_thick_pin_width in i_command_Variable_Handlers */
...
/** @brief function i_cmd_thin_line_width in i_command_Variable_Handlers */
COMMAND ( thin_line_width ) {

  SHOW_VARIABLE(thin_line_width, T)
}
/** @brief function i_cmd_thin_net_width in i_command_Variable_Handlers */
COMMAND ( thin_net_width ) {

  SHOW_VARIABLE(thin_net_width, T)
}
/** @brief function i_cmd_thin_pin_width in i_command_Variable_Handlers */
COMMAND ( thin_pin_width ) {

  SHOW_VARIABLE(thin_pin_width, T)
}

/** @brief function i_cmd_bus_ripper_rotation in i_command_Variable_Handlers */
COMMAND ( bus_ripper_rotation ) {

  SHOW_VARIABLE(bus_ripper_rotation, W)
}

/** @brief function i_cmd_bus_ripper_size in i_command_Variable_Handlers */
COMMAND ( bus_ripper_size ) {

  SHOW_VARIABLE(bus_ripper_size, W)
}
/** @brief function i_cmd_bus_ripper_type in i_command_Variable_Handlers */
COMMAND ( bus_ripper_type ) {

  SHOW_VARIABLE(bus_ripper_type, W)
}
/** @brief function i_cmd_bus_ripper_symname in i_command_Variable_Handlers */
COMMAND(bus_ripper_symname) {

  s_log_message("<%s>", w_current->bus_ripper_symname);
}

/** @brief function i_cmd_fast_mousepan in i_command_Variable_Handlers */
COMMAND ( fast_mousepan ) {

  SHOW_VARIABLE(fast_mousepan, W)
}

/** @brief function i_cmd_drag_can_move in i_command_Variable_Handlers */
COMMAND ( drag_can_move ) {

  SHOW_VARIABLE(drag_can_move, W)
}

/** @brief function i_cmd_middle_button in i_command_Variable_Handlers */
COMMAND ( middle_button ) {

  SHOW_VARIABLE(middle_button, W)
}

/** @brief function i_cmd_third_button in i_command_Variable_Handlers */
COMMAND ( third_button ) {

  SHOW_VARIABLE(third_button, W)
}

/** @brief function i_cmd_mousepan_gain in i_command_Variable_Handlers */
COMMAND ( mousepan_gain ) {

  SHOW_VARIABLE(mousepan_gain, W)
}

/** @brief function i_cmd_scroll_wheel in i_command_Variable_Handlers */
COMMAND ( scroll_wheel ) {

  SHOW_VARIABLE(scroll_wheel, W)
}

/** @brief function i_cmd_image_color in i_command_Variable_Handlers */
COMMAND (image_color) {

  SHOW_VARIABLE(image_color, T)
}
/** @brief function i_cmd_invert_images in i_command_Variable_Handlers */
COMMAND (invert_images) {

  SHOW_VARIABLE(invert_images, T)
}
/** @brief function i_cmd_text_case in i_command_Variable_Handlers */
COMMAND ( text_case ) {

  SHOW_VARIABLE(text_case, W)
}

/** @brief function i_cmd_text_display_zoomfactor in i_command_Variable_Handlers */
COMMAND ( text_display_zoomfactor ) {

  SHOW_VARIABLE(text_display_zoomfactor, W)
}

/** @brief function i_cmd_text_feedback in i_command_Variable_Handlers */
COMMAND ( text_feedback ) {

  SHOW_VARIABLE(text_feedback, W)
}

/** @brief function i_cmd_text_origin_marker in i_command_Variable_Handlers */
COMMAND ( text_origin_marker ) {

  SHOW_VARIABLE(text_origin_marker, R)
}
/** @brief function i_cmd_text_marker_size in i_command_Variable_Handlers */
COMMAND ( text_marker_size ) {

  SHOW_VARIABLE(text_marker_size, R)
}
/** @brief function i_cmd_text_size in i_command_Variable_Handlers */
COMMAND ( text_size ) {

  SHOW_VARIABLE(text_size, W)
}

/** @brief function i_cmd_undo_control in i_command_Variable_Handlers */
COMMAND ( undo_control ) {

  SHOW_VARIABLE(undo_control, W)
}

/** @brief function i_cmd_undo_levels in i_command_Variable_Handlers */
COMMAND ( undo_levels ) {

  SHOW_VARIABLE(undo_levels, W)
}

/** @brief function i_cmd_undo_panzoom in i_command_Variable_Handlers */
COMMAND ( undo_panzoom ) {

  SHOW_VARIABLE(undo_panzoom, W)
}

/** @brief function i_cmd_undo_type in i_command_Variable_Handlers */
COMMAND ( undo_type ) {
