...
;;
     `( (,(N_ "_Undo")              edit-undo             #f                  ,(N_ "Undo the last action"))
        ...
        (,(N_ "Color...")           edit-color            #f                  ,(N_ "Open the Color Editor Dialog"))
...
;;
     `( (,(N_ "_Attach")           attributes-attach             "gtk-go-up"              ,(N_ "Attach selected attributes to symbol"))
        ...
        (,(N_ "Show _Value")       attributes-show-value         "show-value"             ,(N_ "Set selected value visible"))
        (,(N_ "Show _Name")        attributes-show-name          "show-name"              ,(N_ "Set selected name visible"))
        (,(N_ "Show _Both")        attributes-show-both          "show-both"              ,(N_ "Set selected name and value visible"))
        ("SEPARATOR"                    #f                       #f)
        (,(N_ "_Toggle Visibility")      attributes-visibility   "attribute-visibility"   ,(N_ "Toggle attribute visibilty"))
        (,(N_ "_Reset Position")         attributes-home         "attribute-reset"        ,(N_ "Restore attribute positions and orientation"))
