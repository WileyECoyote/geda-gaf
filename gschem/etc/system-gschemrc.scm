...
(map-keys "B <Shift>F" "attributes-find-text")
...
(map-icon "gschem-zoom-extents"        "view-zoom-extents")
(map-icon "gschem-zoom-in"             "view-zoom-in")
(map-icon "gschem-zoom-out"            "view-zoom-out")
(map-icon "gschem-zoom-mag"            "view-zoom-to-mag")
...
(map-icon "gschem-show-value"          "attributes-show-value")
(map-icon "gschem-show-name"           "attributes-show-name")
(map-icon "gschem-show-both"           "attributes-show-both")
(map-icon "attribute-visibility"       "attributes-visibility")
(map-icon "gschem-attribute-reset"     "attributes-home")
