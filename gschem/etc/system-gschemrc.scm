...
;;
     `( (,(N_ "_Component...")     add-component           "geda-component"   ,(N_ "Insert a library symbol"))
        ...
        (,(N_ "Pictu_re...")       add-picture             "gtk-orientation-portrait" ,(N_ "Insert an image"))
...
;;
     `(
        ...
        ("SEPARATOR"                   #f                         #f)
        (,(N_ "Component D_ocumentation...")hierarchy-documentation "gtk-index"      ,(N_ "Find component documentation"))
        ("SEPARATOR"                   #f                         #f)
