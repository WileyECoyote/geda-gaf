...
WidgetStringData DialogStrings[] = {
  ...
  /* Spinner Controls in Alphabetical order */
    ...
    /* Strings for Switch Controls */
        { "AutoLoadSwitch",             "    Auto Last:",	"Enable or disable automatic loading of the last edited schematic."},
        { "AutoSaveSwitch",             "Auto Save:",		"Controls if a backup copy is made every interval. Note that the backup copy is made when you make some change to the schematic and there were more than the interval from the last auto-save."},
