...
WidgetStringData DialogStrings[] = {
  ...
  /* Spinner Controls by Alphabetical TAB order */
        ...
        { "TextSnapSizeSpin",           "    Snap Size:",	"Sets the default spacing which text snaps to."},
    ...
    /* Strings for Switch Controls */
        ...
        { "DelayScrollingSwitch",       "Delay Scrolling:",	"Specifies the behavior of the scrollbars in the main window. When disabled the display is redrawn as you move the scrollbars. When enabled the display is redrawn once you stop moving the scrollbars"},
