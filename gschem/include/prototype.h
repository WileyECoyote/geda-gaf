...
/* i_callbacks.c */
void i_callback_file_new(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_file_new(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_file_new_window(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_file_open(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_file_open(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_file_script(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_file_save(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_file_save(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_file_save_all(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_file_save_as(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_file_save_as(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_file_print(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_file_print(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_file_write_png(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_write_pdf(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_file_close(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_close(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_file_quit(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_undo(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_undo(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_redo(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_redo(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_select(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_select(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_select_all(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_deselect(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_deselect(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_copy(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_copy_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_copy(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_mcopy(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_mcopy_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_mcopy(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_move(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_move_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_move(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_delete(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_edit(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_pin_type(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_text(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_slot(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_color(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_color(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_rotate_90(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_rotate_90_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_rotate(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_mirror(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_mirror_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_mirror(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_lock(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_lock(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_unlock(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_unlock(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_translate(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_invoke_macro(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_embed(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_unembed(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_update(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_show_hidden(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_find(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_hide_text(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_show_text(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_edit_autonumber_text(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_autonumber(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_linetype(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_linetype(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_edit_filltype(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_edit_filltype(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_view_redraw(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_zoom_full(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_zoom_extents(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_zoom_box(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_zoom_box_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_zoom_in(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_zoom_out(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_zoom_in_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_zoom_out_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_pan(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_view_redraw(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_zoom_pan(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_zoom_box(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_zoom_extents(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_zoom_in(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_zoom_out(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_zoom_limits(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_view_pan_left(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_pan_right(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_pan_up(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_pan_down(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_pan_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_dark_colors(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_light_colors(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_view_bw_colors(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_page_manager(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_page_next(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_page_prev(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_page_new(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_page_manager(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_page_close(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_page_revert(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_page_discard(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_page_new(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_page_next(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_page_prev(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_page_print(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_clipboard_copy(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_clipboard_cut(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_clipboard_paste(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_clipboard_paste_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_copy1(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_copy2(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_copy3(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_copy4(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_copy5(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_cut1(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_cut2(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_cut3(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_cut4(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_cut5(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste1(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste2(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste3(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste4(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste5(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste1_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste2_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste3_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste4_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_buffer_paste5_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_clipboard_cut(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_clipboard_copy(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_clipboard_paste(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_component(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_component(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_attribute(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_attribute_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_attribute(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_net(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_net_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_net(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_bus(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_bus_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_bus(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_text(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_text(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_line(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_line_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_line(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_box(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_box_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_box(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_picture(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_picture_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_picture(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_circle(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_circle_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_circle(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_arc(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_arc_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_arc(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_add_pin(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_add_pin_hotkey(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_add_pin(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_hierarchy_down_schematic(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_hierarchy_down_symbol(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_hierarchy_up(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_down_schematic(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_down_symbol(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_hierarchy_up(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_cdocumentation(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_attributes_attach(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_attributes_detach(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_attributes_show_name(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_attributes_show_value(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_attributes_show_both(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_attributes_visibility_toggle(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_toolbar_attach_attributes(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_detach_attributes(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_attributes_show_value(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_attributes_show_name(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_attributes_show_both(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_attributes_visibility(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_find_attribute(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_hide_text(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_toolbar_show_text(GtkWidget *widget, GSCHEM_TOPLEVEL* w_current);
void i_callback_script_console(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_options_text_size(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_options_snap_size(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_options_scale_up_snap_size(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_options_scale_down_snap_size(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_options_afeedback(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_options_grid(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
...
void i_callback_misc2(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_misc3(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_cancel(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_help_about(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_help_hotkeys(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
void i_callback_options_show_coord_window(GSCHEM_TOPLEVEL* w_current, unsigned int callback_action, GtkWidget *widget);
...
char * generic_filesel_dialog(const char *, const char *, int);
...
void x_log_open ();
void x_log_close ();
void x_log_message (const char *log_domain,
                    GLogLevelFlags log_level,
                    const char *message);
/* x_misc.c */
bool x_show_uri (GSCHEM_TOPLEVEL *w_current, const char *buf, GError **err);
/* x_menus.c */
