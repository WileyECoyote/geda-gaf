...
(define *testdirconf* (string-append *testdir* separator "gafrc"))
(define *testdirA* (string-append *testdir* separator "A"))
(define *testdirAconf* (string-append *testdirA* separator "gafrc"))
(define *testdirB* (string-append *testdir* separator "B"))
(define *testdirBconf* (string-append *testdirB* separator "gafrc"))
...
(begin-config-test 'path-config-context
  ...
  (assert-equal #f (config-filename (path-config-context "/__missing/file/")))
