...
bool o_arc_within_sweep(ARC *arc, gint x, gint y);
void world_get_arc_bounds(TOPLEVEL *toplevel, OBJECT *object, int *left, int *top, int *right, int *bottom);
bool o_arc_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_box_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_bus_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_circle_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_complex_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_line_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_net_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_path_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_picture_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_pin_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
...
bool o_text_get_position(TOPLEVEL *toplevel, gint *x, gint *y, OBJECT *object);
