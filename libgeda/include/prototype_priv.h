/* a_basic.c */
char *o_save_objects(TOPLEVEL *toplevel, const GList *object_list, bool save_attribs);
...
bool o_arc_get_position(TOPLEVEL *toplevel, int *x, int *y, OBJECT *object);
...
bool o_box_get_position(TOPLEVEL *toplevel, int *x, int *y, OBJECT *object);
...
bool o_bus_get_position(TOPLEVEL *toplevel, int *x, int *y, OBJECT *object);
...
bool o_circle_get_position(TOPLEVEL *toplevel, int *x, int *y, OBJECT *object);
...
bool o_complex_get_position(TOPLEVEL *toplevel, int *x, int *y, OBJECT *object);
...
bool o_path_get_position(TOPLEVEL *toplevel, int *x, int *y, OBJECT *object);
...
bool o_picture_get_position(TOPLEVEL *toplevel, int *x, int *y, OBJECT *object);
...
bool o_text_get_position(TOPLEVEL *toplevel, int *x, int *y, OBJECT *object);
