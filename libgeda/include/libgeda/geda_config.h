...
char **eda_config_get_groups (EdaConfig *cfg, gsize *length) G_GNUC_WARN_UNUSED_RESULT;
bool   eda_config_has_group (EdaConfig *cfg, const char *group);
char **eda_config_get_keys (EdaConfig *cfg, const char *group, gsize *length, GError **error) G_GNUC_WARN_UNUSED_RESULT;
...
int     *eda_config_get_int_list (EdaConfig *cfg, const char *group, const char *key, gsize *length, GError **err) G_GNUC_WARN_UNUSED_RESULT;
...
void eda_config_set_double_list (EdaConfig *cfg, const char *group, const char *key, double list[], gsize length);
