libgEDAColor(1)                 0.4.0-20180521                 libgEDAColor(1)
...
FILE FORMAT
       ...
       The  color can be a hex string representation of or #f to disable color
       for the corresponding key entry.
...
DOCUMENTATION
       ...
       libgEDAColor use "make doxygen" from within the top libgEDAColor direc-
       tory. Note that the configure script can also set the configuration  to
       allows generating the source documentation out of the source tree using
       the  --with-doxygen-out  option.  For  example  using   --with-doxygen-
